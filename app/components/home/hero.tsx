  ...
  return (
    <div>
      <div className="bg-gradient-to-t from-slate-200 to-white">
        <div className="border-r-2 border-dashed border-l container  max-w-5xl mx-auto grid grid-cols-1 gap-5 justify-center items-center w-full h-[700px]">
          <div>
            <div className="text-center space-y-8">
              ...
              <div className="flex gap-5 justify-center">
                <button className="btn lg:text-lg text-sm bg-secondary text-white">
