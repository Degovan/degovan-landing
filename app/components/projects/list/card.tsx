    ...
    <div className="card cursor-pointer p-1 lg:h-[350px] md:h-[430px]  break-inside-avoid transition-all border bg-white group overflow-hidden relative">
      <div className="p-1 overflow-hidden relative border bg-[#EFF4F8] ">
        <img
          ...
          width={300}
          height={200}
          className="w-full aspect-[3/2]  duration-300 object-top object-cover transition-transform relative z-10 transform translate-y-0 group-hover:-translate-y-3"
          alt={title}
        />
      ...
      <div className="p-5 relative z-10 space-y-3 w-full duration-300 transition-transform  bg-white transform -translate-y-1 group-hover:-translate-y-8">
        <h2 className="font-semibold tracking-tighter lg:text-lg text-xl text-gray-600">
